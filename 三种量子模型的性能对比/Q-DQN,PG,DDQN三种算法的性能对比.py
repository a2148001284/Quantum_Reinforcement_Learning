...
file_path1="q-DDQN采样池控制16.txt"
file_path2="q-DQN.txt"
file_path3="q-PG.txt"
list1 = []
list2 = []
list3 = []
...
#画组合的图
def opt2():
    plt.plot(list1,list2,label="Q-DQQN",color="orange")
    plt.plot(list3,list4,label="Q-DQN",color="blue")
    plt.plot(list5, list6, label="Q-PG", color="green")
    plt.xlabel('Epsiode')
