...
file_path1="DDQN不同采样大小的研究 采样16 阈值200.txt"
file_path2="DDQN不同采样大小的研究 采样32 阈值200.txt"
file_path3="DDQN不同采样大小的研究 采样64 阈值200.txt"
file_path4="DDQN不同采样大小的研究 采样128 阈值200.txt"
list1 = []
list2 = []
list3 = []
list4 = []
...
def draw():
    plt.plot(list1,list2,label="DDQN-batch16",color="orange")
    plt.plot(list1,list4,label="DDQN-batch32",color="blue")
    plt.plot(list1,list6, label="DDQN-batch64", color="green")
    plt.plot(list1,list8, label="DDQN-batch128", color="red")
    plt.xlabel('Epsiode')
